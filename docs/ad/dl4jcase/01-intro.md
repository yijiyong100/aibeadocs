...
- [Java (developer version)](https://deeplearning4j.org/docs/latest/deeplearning4j-quickstart#Java) 1.7 或更高版本 (仅支持64位版本)
- [Apache Maven](https://deeplearning4j.org/docs/latest/deeplearning4j-quickstart#Maven) (自动化构建和依赖管理器)
- [IntelliJ IDEA](https://deeplearning4j.org/docs/latest/deeplearning4j-quickstart#IntelliJ) 或 Eclipse
- [Git](https://deeplearning4j.org/docs/latest/deeplearning4j-quickstart#Git)
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ad/dl4jcase/intro-1.png')" alt="wxmp">

select directory

1. 选择 ‘Import project from external model’ 并确保Maven被选择

2. <img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ad/dl4jcase/intro-2.png')" alt="wxmp">
...
5. <img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ad/dl4jcase/intro-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ad/dl4jcase/intro-4.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ad/dl4jcase/intro-5.png')" alt="wxmp">
...
- [Deeplearning4j artifacts on Maven Central](https://search.maven.org/#search|ga|1|deeplearning4j)
- [ND4J artifacts on Maven Central](https://search.maven.org/#search|ga|1|nd4j)
- [Datavec artifacts on Maven Central](https://search.maven.org/#search|ga|1|datavec)
...
答: 你可能丢失了Spark要求的一些依赖。查看这个[Stack Overflow discussion](https://stackoverflow.com/a/38735202/3892515)来获得一个一个潜在的依赖问题讨论。windows用户可能需要来自Hadoop的winutils.exe。 从https://github.com/steveloughran/winutils and put it into the null/bin/winutils.exe下载winutils.exe （或创建一个hadoop文件夹并添加它到HADOOP_HOME）。
...
如果你想将模型部署到生产中，你可能会喜欢我们的[从Keras导入的模型](https://deeplearning4j.org/docs/latest/keras-import-get-started)。
...
如果你想要一个灵活的深度学习API，这有两种方式。你可以单独使用nd4j，查看我们的 [nd4j ](https://github.com/deeplearning4j/dl4j-examples/tree/master/nd4j-examples)示例 或 [计算图API](https://deeplearning4j.org/compgraph).

如果你想要在 Spark进行分布式训练，你可以查看我们的 [Spark page](https://deeplearning4j.org/spark)记住我们不会为你设置spark
...
- [Arbiter: 超参数优化和模型评估](https://deeplearning4j.org/docs/latest/arbiter-overview)
- [DataVec: 用于机器学习数据管道的内置ETL工具](https://deeplearning4j.org/docs/latest/datavec-overview)
