...
::: tip
本文主要是介绍 机器学习-和深度学习的区别 。
:::

[[toc]]

## 人工智能（AI）、机器学习（machine learning）和深度学习（deep learning）区别
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ai/mlintro/diff-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ai/mlintro/diff-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ai/mlintro/diff-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/ai/mlintro/diff-4.png')" alt="wxmp">
...
吴教授的突破在于，把这些神经网络从基础上显著地增大了。层数非常多，神经元也非常多，然后给系统输入海量的数据，来训练网络。在吴教授这里，数据是一千万YouTube视频中的图像。吴教授为深度学习（deep learning）加入了“深度”（deep）。这里的**深度就是说神经网络中众多的层**。
...
## 参考文章
* https://www.cnblogs.com/zlslch/p/6964698.html