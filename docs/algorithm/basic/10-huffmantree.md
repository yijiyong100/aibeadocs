...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/basic/haffman-1.png')" alt="wxmp">
图1 哈夫曼树
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/basic/haffman-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/basic/haffman-3.png')" alt="wxmp">
图 4 两种哈夫曼树
