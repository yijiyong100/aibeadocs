...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/basic/mst-2.png')" alt="wxmp">



## 完整代码(Prim算法(普里姆算法))
## 完整代码(Kruskal算法(克鲁斯卡尔算法))
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/basic/mst-4.png')" alt="wxmp">
