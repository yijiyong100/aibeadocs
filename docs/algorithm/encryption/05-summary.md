...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/encryption/summary-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/encryption/summary-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/algorithm/encryption/summary-3.png')" alt="wxmp">
