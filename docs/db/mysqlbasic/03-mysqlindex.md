...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/db/mysqlbasic/idx-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/db/mysqlbasic/idx-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/db/mysqlbasic/idx-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/db/mysqlbasic/idx-4.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/db/mysqlbasic/idx-5.png')" alt="wxmp">
...
## 参考文章
* https://www.cnblogs.com/liliuguang/p/13201298.html