...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/dw/intro/sum-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/dw/intro/sum-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/dw/intro/sum-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/dw/intro/sum-4.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/dw/intro/sum-5.png')" alt="wxmp">

雪花模型

**相比较而言，星形模型使用的是反规范化数据**。在星形模型中，维度直接指的是事实表，业务层级不会通过维度之间的参照完整性来部署。

<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/dw/intro/sum-6.png')" alt="wxmp">
