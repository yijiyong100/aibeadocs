...
这几种类加载器的层次关系如下图所示：
 ...
 <img class= "zoom-custom-imgs" :src="$withBase('/assets/img/java/jvm/classload-1.png')" alt="wxmp">

 <img class= "zoom-custom-imgs" :src="$withBase('/assets/img/java/jvm/classload-2.png')" alt="wxmp">
...
## 参考文章
* https://www.cnblogs.com/xifengxiaoma/p/9414982.html