...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/dbbasic/mybatis-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/dbbasic/mybatis-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/dbbasic/mybatis-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/dbbasic/mybatis-4.png')" alt="wxmp">
