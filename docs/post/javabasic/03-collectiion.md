...
::: tip
本文主要是介绍 Java集合容器面试题，面试题和相关解答来自网络，难免有纰漏和疏忽，阅读的时候，发现有疑问的地方，建议多方求证，也可以关注原文评论区，也欢迎在本站[【问题反馈页面】](https://www.yijiyong.com/about/aboutqa.html)留言反馈。
:::
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-2.png')" alt="wxmp">

#### JDK1.8之后

相比于之前的版本，jdk1.8在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为8）时，将链表转化为红黑树，以减少搜索时间。

<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-4.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-5.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-6.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-7.png')" alt="wxmp">

JDK1.7的ConcurrentHashMap：

<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-8.png')" alt="wxmp">

JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）：

<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-9.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-10.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/javabasic/collection-11.png')" alt="wxmp">
