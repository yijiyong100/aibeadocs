...
::: tip
本文主要是介绍 Linux面试题，面试题和相关解答来自网络，难免有纰漏和疏忽，阅读的时候，发现有疑问的地方，建议多方求证，也可以关注原文评论区，也欢迎在本站[【问题反馈页面】](https://www.yijiyong.com/about/aboutqa.html)留言反馈。
:::
...
- 开启 80 端口，因为web对外都是这个端口
  ...
  ```shell
  iptables -A INPUT -p tcp --dport 80 -j ACCEP1
  ```
