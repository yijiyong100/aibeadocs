...
::: tip
本文主要是介绍 架构设计分布式基础面试题，面试题和相关解答来自网络，难免有纰漏和疏忽，阅读的时候，发现有疑问的地方，建议多方求证，也可以关注原文评论区，也欢迎在本站[【问题反馈页面】](https://www.yijiyong.com/about/aboutqa.html)留言反馈。
:::
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-1.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-3.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-4.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-5.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-6.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-7.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-8.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-9.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-10.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/post/sysarchibasic/archidistribute-11.png')" alt="wxmp">
