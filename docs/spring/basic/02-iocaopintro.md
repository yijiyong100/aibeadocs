...
## Spring框架IOC和AOP的实现原理简介

本文讲的是面试之Spring框架IOC和AOP的实现原理， IoC（Inversion of Control） (1). IoC（Inversion of Control）是指**容器**控制**程序对象之间**的**关系**，而不是传统实现中，由**程序代码**直接操控。控制权由**应用代码**中转到了**外部容器**，控制权的转移是IOC。
...
## 参考文章
* https://www.cnblogs.com/yaochunhui/p/14164431.html
