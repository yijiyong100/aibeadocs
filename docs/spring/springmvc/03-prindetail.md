...
> 本文Github开源项目https://github.com/Snailclimb/JavaGuide，只供自己学习总结无商业用途，如有侵权，联系删除
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/spring/springmvc/prindetail-1.jpg')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/spring/springmvc/prindetail-2.png')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/spring/springmvc/prindetail-3.jpg')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/spring/springmvc/prindetail-4.jpg')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/spring/springmvc/prindetail-5.jpg')" alt="wxmp">
...
<img class= "zoom-custom-imgs" :src="$withBase('/assets/img/spring/springmvc/prindetail-6.jpg')" alt="wxmp">
